...
//            window.setNavigationBarColor(Color.TRANSPARENT);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            try {
                if (MIUISetStatusBarLightMode(activity.getWindow(), isDark)) {
                    result = 1;
                    setStatusBarColor(activity, Color.parseColor("#3DA9F1"));
            ...
            } catch (Exception eArp) {
            } finally {
                setLayoutS(activity,isDark);
                return result;
            }
        }
        setLayoutS(activity,isDark);
    ...
    private static void setLayoutS(Activity activity, boolean isDark) {
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            activity.getWindow().setStatusBarColor(Color.parseColor("#3DA9F1"));
        }
    }
